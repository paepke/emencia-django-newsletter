...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'emencia_contact', 'last_name')

        # Deleting field 'Contact.first_name'
        db.delete_column(u'emencia_contact', 'first_name')


    def backwards(self, orm):
        # Adding field 'Contact.last_name'
        db.add_column(u'emencia_contact', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Contact.first_name'
        db.add_column(u'emencia_contact', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
