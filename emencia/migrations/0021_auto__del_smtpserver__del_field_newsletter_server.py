...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Newsletter.server'
        db.delete_column('emencia_newsletter', 'server_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('emencia_smtpserver', (
            ...
            ('emails_remains', self.gf('django.db.models.fields.IntegerField')(default=10000)),
        ...
        # Adding field 'Newsletter.server'
        db.add_column('emencia_newsletter', 'server',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['emencia.SMTPServer']),
                      keep_default=False)
    ...
    models = {
        ...
        'emencia.mailinglist': {
            ...
            'subscribers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'mailinglist_subscriber'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['emencia.Contact']"}),
