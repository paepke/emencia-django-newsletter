...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('emencia_smtpserver', 'emails_remains', self.gf('django.db.models.fields.IntegerField')(default=10000), keep_default=False)

        # Changing field 'Attachment.file_attachment'
        db.alter_column('emencia_attachment', 'file_attachment', self.gf('django.db.models.fields.files.FileField')(max_length=255))


    def backwards(self, orm):
        
        # Deleting field 'SMTPServer.emails_remains'
        db.delete_column('emencia_smtpserver', 'emails_remains')

        # Changing field 'Attachment.file_attachment'
        db.alter_column('emencia_attachment', 'file_attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100))
