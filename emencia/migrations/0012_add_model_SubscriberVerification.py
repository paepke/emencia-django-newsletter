...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('emencia_subscriberverification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('link_id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, blank=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emencia.Contact'])),
        ))
        db.send_create_signal('emencia', ['SubscriberVerification'])


    def backwards(self, orm):
        # Deleting model 'SubscriberVerification'
        db.delete_table('emencia_subscriberverification')
